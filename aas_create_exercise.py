...
def create_exercise(grading_script, image_name, max_time, max_mem, assets, executors):
    body = {
    ...
    util.debug(body)
    resp = requests.post(util.AAS_BASE_URL + '/exercises', json=body, headers=util.get_required_headers())
...
if __name__ == '__main__':
    ...
    create_exercise(grading_script, args.image_name, args.max_time, args.max_mem, assets, args.executors)
